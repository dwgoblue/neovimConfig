...
Plug 'pocco81/auto-save.nvim'         " Autosave: use vim.g.autosave_state to check if autosave is ON/OFF
...
let g:python3_host_prog='~/miniconda3/envs/venv/bin/python'            " ncm2-jedi
...
map <Leader>tm :new term://bash<CR>imatlab<CR><C-\><C-n><C-w>k
map <Leader>tb :vs term://bash<CR>
